/**
 * Text Analysis Provider — v1.5
 *
 * Default analysis provider. Generates UI analysis from inspiration metadata
 * (title, tags, notes, project type) via DeepSeek text model.
 * This is the existing v1.4 logic, now wrapped as a Provider.
 *
 * Server-only.
 */
...
export class TextAnalysisProvider implements AnalysisProvider {
  readonly name = "text";
